...
function About() {
  ...
  return (
    <section className="contenedor-internas fondo-translucido w-[80%]">
      <div className="order-first basis-1/2 px-5 py-3 text-left borde-redondeado">
      ...
      <div className="order-last basis-1/2 px-5 py-3 text-justify borde-redondeado">
        <p className="parrafo">
          Pellentesque habitant morbi tristique <AvatarJJ /> senectus et netus
          et malesuada{" "}
          <a href="/" className="link-con-flecha">
